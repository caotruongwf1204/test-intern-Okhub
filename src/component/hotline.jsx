...
export default function Hotline() {
  return (
    <>
      <div className="wrapper fixed bottom-[-30px] z-50 right-[-40px]">
        <div className="coccoc-alo-phone coccoc-alo-green coccoc-alo-show">
          <div className="coccoc-alo-ph-circle-fill"></div>
          <div className="coccoc-alo-ph-img-circle relative">
            <svg
            ...
            >
              ...
              <path
                ...
                fill="white"
              />
              <g filter="url(#filter0_d_794_866)">
                <circle cx="42" cy="16" r="6" fill="#14FF00" />
              </g>
              <defs>
                <filter
                  id="filter0_d_794_866"
                  x="26"
                  y="0"
                  width="32"
                  height="32"
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_794_866"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_794_866"
                    result="shape"
                  />
                </filter>
              </defs>
